...
public class SmsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        list.add(new Grid("Oferta", "Ofertas móviles"));
        list.add(new Grid("Tarifa", "Tarifas móviles"));
        list.add(new Grid("4G", "Activar servicio 4G"));
        list.add(new Grid("Red", "Redes que soporta su móvil"));
        list.add(new Header("De pago"));
        list.add(new Grid("DHL", "Rastree su paquete"));
        list.add(new Grid("Clima", "Estado del tiempo"));
        list.add(new Grid("Vuelos", "Información de vuelos"));
        list.add(new Grid("Embajadas", "Embajadas en Cuba"));
        list.add(new Grid("Cambio", "Tasa de cambio oficial"));
        list.add(new Grid("Apagón", "Apagón en La Habana"));
        list.add(new Grid("Cubadebate", "Titulares de noticias"));
        list.add(new Grid("Grannma", "Titulares de noticias"));
    }
